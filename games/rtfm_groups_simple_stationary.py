...
class MuZeroConfig:
    def __init__(self):
        ...
        ### Game
        self.observation_shape = (6, 6, 18)  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
